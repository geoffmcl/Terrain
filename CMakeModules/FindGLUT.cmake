# 20150422 - Copied to Terrain Project to do modifications
# FindGLUT
#
...
#
# GLUT::GLUT - Defined if the system has GLUT.
#
# Result Variables
#
...
if (WIN32)
    ...
    if (MSVC)
        find_library( GLUT_LIB_DBG NAMES freeglut_staticd )
        find_library( GLUT_LIB_REL NAMES freeglut_static  )
        if (GLUT_LIB_DBG AND GLUT_LIB_REL)
            set( GLUT_glut_LIBRARY 
                debug ${GLUT_LIB_DBG}
                optimized ${GLUT_LIB_REL} )
        elseif (GLUT_LIB_REL)
            set( GLUT_glut_LIBRARY ${GLUT_LIB_REL} )
        else ()
            find_library( GLUT_LIB_REL NAMES glut glut32 freeglut )
            find_library( GLUT_LIB_DBG NAMES glutd glut32d freeglutd )
            if (GLUT_LIB_DBG AND GLUT_LIB_REL)
                set( GLUT_glut_LIBRARY 
                    debug ${GLUT_LIB_DBG}
                    optimized ${GLUT_LIB_REL} )
        ...
        find_library( GLUT_glut_LIBRARY NAMES glut glut32 freeglut
            PATHS ${OPENGL_LIBRARY_DIR} ${GLUT_ROOT_PATH}/Release )
    endif ()
