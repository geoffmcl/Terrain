...
bool CSkybox::LoadSkybox(string a_sDirectory, string a_sFront, string a_sBack, string a_sLeft, string a_sRight, string a_sTop, string a_sBottom)
{
	if (!tTextures[0].LoadTexture2D(a_sDirectory+a_sFront))
        return false;
	if (!tTextures[1].LoadTexture2D(a_sDirectory+a_sBack))
        return false;
	if (!tTextures[2].LoadTexture2D(a_sDirectory+a_sLeft))
        return false;
	if (!tTextures[3].LoadTexture2D(a_sDirectory+a_sRight))
        return false;
	if (!tTextures[4].LoadTexture2D(a_sDirectory+a_sTop))
        return false;
	if (!tTextures[5].LoadTexture2D(a_sDirectory+a_sBottom))
        return false;
