...
#ifdef _MSC_VER
#pragma warning( disable : 4995 ) // like 'strcpy': name was marked as #pragma deprecated
#endif // _MSC_VER
...
#define  MXIO     512
static char def_log[] = DEF_LOGNAME;
char logfile[256] = "\0";
FILE * outfile = NULL;
...
#ifdef _MSC_VER // TODO: needs more work for unix
//#ifdef UNICODE
// WIDE VARIETY
static void wprt( PWSTR ps )
{
   ...
   if(len) {
       memset(cp,0,1024); // function does NOT seem to ZERO TERMINATE the string!!!
...
int MCDECL wsprtf( PWSTR pf, ... )
{
   ...
   va_start(arglist, pf);
   *pb = 0;
   StringCchVPrintfW(pb,1024,pf,arglist);
   //i = vswprintf( pb, pf, arglist );
   va_end(arglist);
   wprt(pb);
   return i;
}
#endif // #ifdef ADD_WIDE_CHAR

//#endif // #ifdef UNICODE
#endif // #ifdef _MSC_VER // TODO: needs more work for unix
